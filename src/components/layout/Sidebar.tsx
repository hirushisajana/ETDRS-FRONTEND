...
const allSections: { title: string; items: NavItem[] }[] = [
  {
    ...
    items: [
      ...
      { label: 'Audit History', path: '/audit-history', icon: 'M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125M3.375 19.5h1.5C5.496 19.5 6 18.996 6 18.375m-2.625 1.125c-1.035 0-1.875-.84-1.875-1.875v-1.5C1.5 12.9 3.375 11.25 3.375 11.25s1.875 1.65 1.875 3.75v1.5c0 .462-.269.858-.66 1.044.225.559.009.967-.093 1.151.445-7.662 2.5-11.269 4.984-15.176.664-1.041 1.71-.864 1.71-.864s.436 1.853-.246 3.645c-.313.823-.743 1.683-1.156 2.486.667.353 1.199.857 1.539 1.597.225.49.34 1.016.327 1.56m0 0c-.014.309-.115.884-.302 1.41h5.346m-5.346-1.41c-.01.342.048.703.158 1.053.222.706.74 1.257 1.433 1.536M18.375 18.375c-.99-.32-1.5-.705-1.5-1.89m0-3.75c1.605 0 2.625.315 2.625 1.89 0 .42-.132.51-.24.84-.166.51-.36 1.38-.36 2.07 0 1.77-.186 2.88-1.53 2.88-.067 0-.134-.02-.198-.057a1.125 1.125 0 01-.09-.033c-.271.005-.54.007-.81.008-1.19-.158-2.177-1.024-2.323-1.898m3-3.998c.007 1.59-.015 3.18 0 4.77m-3.48-4.77a4.002 4.002 0 01-3.753.003', roles: ['REGISTRY_ADMIN', 'SUPER_ADMIN'] },
      { label: 'RG Configuration', path: '/rg-configuration', icon: 'M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z', roles: ['SUPER_ADMIN'] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Six-Month Updates', path: '/daybook/counter', tab: 'update', icon: 'M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182', roles: ['COUNTER_USER'] },
