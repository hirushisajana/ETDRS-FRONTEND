...
export default function QuarterlyUpdateForm({ onSuccess }: QuarterlyUpdateFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to create quarterly update');
    } finally {
      setLoading(false);
    }
  };
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-actions">
            <button type="submit" className="btn btn-success" disabled={loading}>
              {loading ? 'Creating...' : 'Create Quarterly Update'}
            </button>
          </div>
        </form>
      )}
