          ...
          <form onSubmit={handleSearch} className="flex gap-3">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-maroon-500 focus:border-maroon-500 outline-none"
              />
            </div>
            <button
              type="submit"
          ...
          <div className="flex gap-4 items-center">
            <div>
              ...
              <select
                ...
                className="text-sm border border-gray-300 rounded-lg px-3 py-1.5 focus:ring-2 focus:ring-maroon-500 focus:border-maroon-500 outline-none"
              >
                {years.map((y) => (
            ...
            <div>
              <label className="block text-[11px] font-semibold text-gray-500 uppercase tracking-wider mb-1">Trust Type</label>
              <select
                value={trustType}
